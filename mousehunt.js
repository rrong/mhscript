...
// @author      Nevocaine, nobodyrandom, Ooi Keng Siang, CnN
// @version    	1.3.2
// @description Script automating MH horn sounding, fully functional as of 23/08/2020. Updating the outdated script by nobodyrandom, who adapted the original versions by Ooi and CnN. Latest inputs courtesy of Doreen Koh and Gawz.
...
var objBestTrap = {
    weapon: {
        arcane: ['New Horizon Trap', 'Infinite Winter Horizon Trap', 'Event Horizon Trap', 'Anniversary Arcane Capturing Rod Of Never Yielding Mystery', 'Chrome Grand Arcanum Trap', 'Grand Arcanum Trap', 'Chrome Arcane Capturing Rod Of Never Yielding Mystery', 'Droid Archmagus Trap', 'Arcane Blast Trap', 'Arcane Capturing Rod Of Never Yielding Mystery', 'Nutcracker Nuisance Trap', 'Sprinkly Cupcake Surprise Trap', 'Obelisk of Incineration', 'Obelisk of Slumber'],
        draconic: ['Dragon Slayer Cannon', 'Chrome Storm Wrought Ballista Trap', 'Storm Wrought Ballista Trap', 'Dragonvine Ballista Trap', 'Harrowing Holiday Harpoon Harp', 'Blazing Ember Spear Trap', 'Dragon Lance', 'Cemetery Gate Grappler', 'Ice Maiden'],
        forgotten: ['Infinite Labyrinth Trap', 'Endless Labyrinth Trap', 'Crystal Mineral Crusher Trap', 'Crystal Crucible Trap', 'Festive Forgotten Fir Trap', 'Stale Cupcake Golem Trap', 'Scarlet Ember Root Trap', 'Tarannosaurus Rex Trap', 'Father Winter\'s Timepiece Trap', 'The Forgotten Art of Dance', 'Anniversary Ancient Box Trap', 'Ancient Box Trap', 'Forgotten Pressure Plate Trap'],
        hydro: ['School of Sharks', 'Chrome Phantasmic Oasis Trap', 'Rune Shark Trap', 'Phantasmic Oasis Trap', 'Queso Fount Trap', 'Chrome Oasis Water Node Trap', 'Paradise Falls Trap', 'Oasis Water Node Trap', 'Glacier Gatler', 'Holiday Hydro Hailstone Trap', 'Steam Laser Mk. III', 'Steam Laser Mk. II', 'Double Diamond Adventure', 'Kraken Chaos', 'Explosive Toboggan Ride', 'S.U.P.E.R. Scum Scrubber', 'Steam Laser Mk. I', 'Heat Bath', 'Scum Scrubber', 'Ice Blaster', 'Ancient Spear Gun', 'Haunted Shipwreck Trap', 'Bubbles The Party Crasher Trap', 'Net Cannon', 'Harpoon Gun'],
        law: ['Ember Prison Core Trap', 'Meteor Prison Core Trap', 'Judge Droid Trap', 'The Law Draw', 'Surprise Party Trap', 'Christmas Cactus Trap', 'Law Laser Trap', 'Engine Doubler', 'Bandit Deflector', 'Supply Grabber', 'S.L.A.C. II', 'S.L.A.C.'],
        physical: ['Chrome MonstroBot', 'Sandstorm MonstroBot', 'Smoldering Stone Sentinel Trap', 'Chrome RhinoBot', 'Sandtail Sentinel', 'New Year\'s Fireworks Trap', 'Rocket Propelled Gavel Trap', 'Warden Slayer Trap', 'Enraged RhinoBot', 'Chrome Onyx Mallet', 'Icy RhinoBot', 'RhinoBot', 'Warpath Thrasher', 'Chrome DrillBot', 'Onyx Mallet', 'Digby DrillBot', 'Christmas Cracker Trap', 'PartyBot', 'Chrome DeathBot', 'Birthday Party Pi̱ata Bonanza', 'Anniversary DeathBot', 'Birthday Candle Kaboom', 'Fluffy DeathBot', 'Grungy DeathBot', 'Mouse DeathBot', 'Snowglobe Trap', 'NVMRC Forcefield Trap', 'Pneumatic Tube Trap', 'Ultra MegaMouser MechaBot Trap', 'HitGrab Rainbow Rockin Horse', 'HitGrab Rockin Horse', 'Swiss Army Mouse Trap', 'Festive Gauntlet Crusher', 'Wrapped Gift Trap', 'Ancient Gauntlet', 'Shrink Ray Trap', 'Mouse Rocketine', 'Mouse Trebuchet', 'HitGrab Horsey', 'Mouse Mary O\'Nette', '500 Pound Spiked Crusher', 'High Tension Spring', 'Chrome Tacky Glue Trap', 'Mouse Hot Tub', 'Tacky Glue Trap'],
         rift: ['Chrome Celestial Dissonance', 'Celestial Dissonance Trap', 'Timesplit Dissonance Trap', 'Mysteriously unYielding Null-Onyx Rampart of Cascading Amperes', 'Christmas Crystalabra Trap', 'Wacky Inflatable Party People Trap', 'Rift Glacier Gatler', 'Multi-Crystal Laser', 'Biomolecular Re-atomizer Trap', 'Focused Crystal Laser', 'Crystal Tower'],
        shadow: ['Chrome Temporal Turbine', 'Temporal Turbine', 'Anniversary Reaper\'s Perch', 'Goldfrost Crossbow Trap', 'Clockwork Portal Trap', 'Interdimensional Crossbow Trap', 'Reaper\'s Perch', 'Moonbeam Barrier Trap', 'Admiral\'s Galleon Trap', 'Candy Crusher Trap', 'Maniacal Brain Extractor', 'Terrifying Spider Trap', 'Sandcastle Shard Trap', 'Soul Harvester', 'Cackle Lantern Trap', 'Dreaded Totem Trap', 'Clockapult of Winter Past', 'Clockapult of Time', 'Gorgon Trap', 'Creepy Coffin Trap', 'Brain Extractor', 'Chrome Nannybot', 'Soul Catcher', 'Bottomless Grave', 'Pumpkin Pummeler', 'Ambrosial Portal', 'Sinister Portal'],
        tactical: ['Chrome Sphynx Wrath', 'Gouging Geyserite Trap', 'Sphynx Wrath', 'Anniversary Ambush', 'Dimensional Chest Trap', 'Rewers Riposte', '2010 Blastoff Trap', '2012 Big Boom Trap', 'Well of Wisdom Trap', 'Snow Barrage', 'Giant Speaker', 'Zugzwang\'s Ultimate Move', 'Veiled Vine Trap', 'Chesla\'s Revenge', 'Zugzwang\'s First Move', 'Horrific Venus Mouse Trap', 'S.A.M. F.E.D. DN-5', 'Thorned Venus Mouse Trap', 'Obvious Ambush Trap', 'Blackstone Pass Trap', 'Ninja Ambush Trap', 'Ambush', 'Zurreal\'s Folly', 'Mutated Venus Mouse Trap', 'Gingerbread House Surprise', 'Zugzwang\'s Last Move', 'Venus Mouse Trap', 'Mystic Pawn Pincher', 'Technic Pawn Pincher']
    },
    base: {
...
function eventLocationCheck(caller) {
    ...
    console.log(getPageVariable("user.environment_name"));
    switch (selAlgo) {
        case 'Hunt For':
            huntFor();
            break;
...
function bwRift() {
    ...
    var objBWRift = {
        ...
        minTimeSand: [60, 60, 45, 45, 45, 45, 45, 45, 999],
        minRSCType: 'GEQ',
        minRSC: 0,
    ...
    // Frozen alcove
    objBWRift.master.bait[7] = "Brie String";
...
function vRift() {
    ...
    if (objUser.is_at_eclipse && !bTowerActive) {
      // Enable
      fireEvent(classButton, 'click');
    } else if (!objUser.is_at_eclipse && bTowerActive) {
      // Disable
      fireEvent(classButton, 'click');
    }
